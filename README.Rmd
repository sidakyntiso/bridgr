...
```{r visbias, warning = FALSE, message = FALSE,fig.align="center",fig.height=4, fig.width=4}
...
```{r, include=F}
# implement the model
results = readRDS("C:/Users/Sidak Yntiso/Downloads/results.RDS")
```
  

```{r vispost, fig.align="center",fig.height=4, fig.width=4}
# implement the model
